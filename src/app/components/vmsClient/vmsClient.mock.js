(function() {
  'use strict';
  angular.module('vmsFrontend.mock', [])
    .value('registerVolunteerPostMock', {
      'username': 'jimlin',
      'password': 'MYPASSW0RD',
      'first_name': 'Lin',
      'last_name': 'Jim',
    ...
    .value('correctCredentials', {
      'username': 'jimlin',
      'password': 'MYPASSW0RD'
    })
    .value('loginSuccessfulResponseMock', {
      'href': 'https://vms.app/api/users/me',
      'auth_access_token': '56f4da226eb22caa0633023bfdd402658e5c6501c972e83bfb2866f2112b103f'
    })
    .value('emailVerificationSuccessfulResponseMock', {
